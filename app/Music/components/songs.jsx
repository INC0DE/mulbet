...
const Songs = () => {
 ...
 <h1 className="text-gray underline decoration-purple text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-bold p-5 ">Canciones</h1>

      {song.map((song) => (
        <div key={song.id} className="flex flex-col border-1 md:border-0 md:flex-row gap-10 xl:w-3/5">
          <Image src={song.img} alt={song.title} width={400} height={1000} />

          <div className="flex flex-col justify-between">
            <div className="flex flex-col lg:flex-row md:gap-4 text-3xl font-bold font-anonymous">
              <h1 className="">{song.title} -</h1><h1 className="text-purple">{song.year}</h1>
            </div>
